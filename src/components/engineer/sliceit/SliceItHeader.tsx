...
export const SliceItHeader: React.FC = () => {
  ...
  const mainImagePath = '/projects/sliceit.png';
  ...
  const handleScrollToArchitecture = (e: React.MouseEvent<HTMLAnchorElement>) => {
    e.preventDefault();
    const target = document.getElementById('sliceit-architecture');
    if (target) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-10 items-center">
        ...
        <div ref={contentRef} className="md:col-span-7 flex flex-col justify-center text-left space-y-2.5">
          ...
          <div className="group/num flex items-center gap-4 sm:gap-6 sm:-ml-20 mb-1">
            ...
            <div>
              ...
              <p className="font-mono text-xs sm:text-sm text-[#6DB8F5] font-medium">
                Full-Stack Pizza Ordering &amp; Management Platform
              </p>
            </div>
          </div>
          ...
          <p className="font-sans text-xs sm:text-sm text-[#A7B5C7]/90 leading-relaxed">
            A full-stack e-commerce web application streamlining dynamic menu browsing, cart management, secure payments, and order tracking. Built during the Oasis Infobyte task featuring REST APIs, JWT authentication, MongoDB, and Razorpay integration.
          </p>

          {/* Explore Cue Link */}
          <div>
            <a
              href="#sliceit-architecture"
          ...
          <div className="flex flex-wrap items-center gap-4 sm:gap-6 text-xs font-mono border-t border-[#1B3047]/40 pt-3">
            ...
            <div className="flex flex-col space-y-0.5">
              ...
              <a
                href="https://github.com/HarshadaBodkhe/OIBSIP_WebDevelopment_Level3_Task"
                target="_blank"
        ...
        {/* RIGHT COLUMN: Main Project Image (5 Cols) */}
