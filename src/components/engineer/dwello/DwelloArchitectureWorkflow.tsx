...
const WORKFLOW_STEPS = [
  { step: '01', label: 'USER REQUEST' },
  { step: '02', label: 'FRONTEND UI' },
  { step: '03', label: 'EXPRESS API' },
  { step: '04', label: 'MONGODB QUERY' },
  { step: '05', label: 'JSON RESPONSE' },
];

export const DwelloArchitectureWorkflow: React.FC = () => {
          ...
          >
            <div className="flex flex-col items-center gap-2">
              ...
              <div className="w-full flex items-center gap-3 px-3.5 py-2 rounded bg-[#030914] border border-[#1B3047]/50">
                ...
                <div>
                  <span className="font-bold text-[#E8EEF5]">MongoDB Store</span>
                  <span className="text-[10px] text-[#A7B5C7]/70 font-sans ml-2">
                    (Listings &bull; Bookings)
                  </span>
                </div>
              </div>
            </div>
