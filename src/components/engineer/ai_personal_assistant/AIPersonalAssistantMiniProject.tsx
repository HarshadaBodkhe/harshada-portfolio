...
import { ExternalLink, ArrowRight, ArrowDown, Cpu, Server, Bot, MessageSquare } from 'lucide-react';
...
const TECH_STACK = ['Python', 'Google Gemini API', 'Streamlit'];

const TECHNICAL_DETAILS = [
  {
    category: 'LLM ENGINE',
    name: 'Google Gemini API',
    desc: 'Powers conversational reasoning, natural language understanding, and context-aware responses.',
    icon: Bot,
  },
  {
    category: 'APPLICATION UI',
    name: 'Streamlit Framework',
    desc: 'Provides a clean, real-time interactive user interface for conversational interaction and session rendering.',
    icon: Server,
  },
  {
    category: 'LANGUAGE RUNTIME',
    name: 'Python 3',
    desc: 'Handles API requests, state management, prompt construction, and backend orchestration.',
    icon: Cpu,
  },
  {
    category: 'PROMPT ENGINE',
    name: 'Context & Prompt Processing',
    desc: 'Formats user instructions and maintains conversation history for coherent continuous responses.',
    icon: MessageSquare,
  },
];

export const AIPersonalAssistantMiniProject: React.FC = () => {
  ...
  return (
    <section
      id="ai-personal-assistant-mini-project"
      ref={containerRef}
      ...
      <div className="w-full max-w-[880px] mx-auto flex flex-col space-y-10 sm:space-y-12">
        ...
        <div ref={headerRef} className="flex flex-col space-y-4">
          ...
          <p className="font-sans text-sm sm:text-base text-[#A7B5C7]/90 leading-relaxed max-w-3xl">
            An AI-powered personal assistant that uses the Gemini API to understand user requests and generate contextual responses through an interactive conversational interface.
          </p>
          ...
          <div className="flex flex-wrap items-center gap-4 sm:gap-6 text-xs font-mono border-t border-[#1B3047]/40 pt-4">
            ...
            <div className="flex flex-col space-y-0.5">
              ...
              <a
                href="https://github.com/HarshadaBodkhe/AI-Personal-Assistant"
                target="_blank"
